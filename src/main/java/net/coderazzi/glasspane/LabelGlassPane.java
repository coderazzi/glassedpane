...
/**
 * Specific glass pane that extends the basic {@link GlassPane}
 * implementation, placing a {@link JLabel} centered on the pane.
 * <br>
...
public class LabelGlassPane extends GlassPane {
	 ...
	 * icon used by default in the {@link JLabel}. By default, ni icon is used
	 */
    ...
    /**
     * Overrides the {@link GlassPane#setColor(Color)} implementation, to
     * setup the color (without transparency) as the label background.
     */
    @Override
