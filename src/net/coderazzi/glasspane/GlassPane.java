 ...
 *    (not including subclassing mechanisms):<ul>
...
public class GlassPane extends JPanel implements MouseListener, KeyListener 
{
	 ...
	 * color used by default. By default, it corresponds to
	...
	/**
	 * These property can be defined as a system property to specify the
	 * transparency level used by default (integer from 0 to 255). 
	 * By default, it corresponds to {@link GlassPane#DEFAULT_TRANSPARENCY} 
	 */
     ...
     * <br>
     * By default, it is created out of the properties:
     * {@link GlassPane#GLASS_COLOR_PROPERTY} & 
