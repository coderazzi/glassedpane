 ...
 * <p>The provided GlassedPane component's icon forms part of the WYSIWYG 
 * Sapphire set of free icons, available at 
...
public class GlassedPaneBeanInfo extends SimpleBeanInfo {
    ...
    public Image getIcon(int iconKind) {
        if (image==null){
            image=loadImage("/net/coderazzi/glasspane/glasspane.png");           
        }
        return image;
    }
